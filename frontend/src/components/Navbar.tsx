...
import { Moon, Sun, ShieldCheck, LayoutDashboard, LogOut } from "lucide-react";
...
export default function Navbar() {
  ...
  /* Don't show the landing-page navbar inside the dashboard (it has its own sidebar) */
          ...
          <div className="flex items-center gap-4">
            ...
            {authenticated ? (
              <>
                <Link
                  href="/dashboard"
                  className="hidden sm:inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium rounded-md bg-[var(--color-accent-blue)] text-white hover:opacity-90 transition-all shadow-[0_0_15px_rgba(45,91,255,0.3)]"
                >
              ...
              <>
                <Link
                  href="/dashboard"
                  className="hidden sm:inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md bg-[var(--color-accent-blue)] text-white hover:opacity-90 transition-all shadow-[0_0_15px_rgba(45,91,255,0.3)]"
                >
                  Run free audit
                </Link>
